...
err_cv <- array(dim=c(length(model_values), 2))
 for(k in 1:length(model_values)){
   ...
   cat("depth=", model_values[k], " shrinkage=", shrinkage[m], "\n")
  err_cv[k,] <- cv.function(feat_train, label_train, model_values[k],shrinkage[m], K)
   }
 }
...
if(run.cv){
  ...
  plot(model_values, err_cv[,1], xlab="Interaction Depth", ylab="CV Error",
       main="Cross Validation Error with skrinkage", type="n", ylim=c(0, 0.25))
